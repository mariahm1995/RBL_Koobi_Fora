#' Ecometric Model for Qualitative Traits
#'
#' Builds an ecometric trait space for categorical (qualitative) traits, estimating the most probable category
#' and the probability of each category at each trait bin combination. Also calculates prediction accuracy
...
#' \item{points_df}{Points with predictions and anomalies.}
#' \item{eco_space}{Trait bin grid with category estimates and probabilities.}
...
#' @export
ecometric_model_qualitative <- function(points_df,
                                        category_col,
                                        grid_bins_mean = NULL,
                                        grid_bins_sd = NULL,
                                        min_species = 3) {
